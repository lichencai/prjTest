...
public class ClientPoint implements Runnable{
    ...
    public void run() {     
        ...
        try {
            ...
            System.out.println("channel system address : " + channel.hashCode());
            ...
            while(!isOver){
                ...
                while(ite.hasNext()){
                    ...
                    //System.out.println("is the same object : " + (selectableChannel == channel));
